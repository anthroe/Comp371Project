...
unsigned int Drawer::loadCubemap(vector<std::string> faces)
{
...
GLuint Drawer::setupModelVBO(std::string path, int& vertexCount) {
...
GLuint Drawer::setupModelEBO(std::string path, int& vertexCount) {
